...
| [auth.tokenExpiresAtBufferMs] | <code>number</code> | <code>600000</code> | The amount of time differentiating   between when we consider a token to be stale and when it truly expires. The larger the number,   the more aggressively we will consider a token invalid. Defaults to 10 minutes. |
